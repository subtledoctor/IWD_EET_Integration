...
IF ~~ THEN BEGIN 31
  SAY @25888
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN DO ~SetGlobal("Emmerich_Quest","GLOBAL",2)
                 AddXP2DA("ID1EX12H")
                 DisplayStringNoNameDlg(LastTalkedToBy,@24884)~ GOTO 32
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN DO ~SetGlobal("Emmerich_Quest","GLOBAL",2)
                 AddXP2DA("ID1EX2H")
                 DisplayStringNoNameDlg(LastTalkedToBy,@24884)~ GOTO 32
END
...
IF ~~ THEN BEGIN 35
  SAY @25896
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @26028 DO ~SetGlobal("Emmerich_Quest","GLOBAL",3)
                              AddXP2DA("ID1EX12H")
  ...
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @26028 DO ~SetGlobal("Emmerich_Quest","GLOBAL",3)
                              AddXP2DA("ID1EX2H")
                              DisplayStringNoNameDlg(LastTalkedToBy,@24885)
                              EraseJournalEntry(@25429)
                              EraseJournalEntry(@25431)
