...
IF ~NumTimesTalkedToGT(0)
  ...
  IF ~Global("Ambere_Family","GLOBAL",0)
      ...
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22179 DO ~ReputationInc(-1)
                                                                AddXP2DA("ID1EX6E")
  ...
  IF ~Global("Ambere_Family","GLOBAL",0)
      Global("Tybald_Pissed","GLOBAL",0)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22179 DO ~ReputationInc(-1)
                                                                AddXP2DA("ID1EX1E")
                                                                DisplayStringNoNameDlg(LastTalkedToBy,@11863)
                                                                SetGlobal("Tybald_Pissed","GLOBAL",1)
                                                                EraseJournalEntry(@23781)
  ...
  IF ~Global("Ambere_Family","GLOBAL",1)
      Global("Tybald_Pissed","GLOBAL",0)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22182 DO ~ReputationInc(-1)
                                                                AddXP2DA("ID1EX6E")
  ...
  IF ~Global("Ambere_Family","GLOBAL",1)
      Global("Tybald_Pissed","GLOBAL",0)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22182 DO ~ReputationInc(-1)
                                                                AddXP2DA("ID1EX1E")
                                                                DisplayStringNoNameDlg(LastTalkedToBy,@14414)
                                                                SetGlobal("Tybald_Pissed","GLOBAL",1)
                                                                EraseJournalEntry(@23781)
...
IF ~~ THEN BEGIN 37
  SAY @22332
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22334 DO ~SetGlobal("Quinn_Tybald","GLOBAL",2)
                              AddXP2DA("ID1EX6A")
  ...
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22334 DO ~SetGlobal("Quinn_Tybald","GLOBAL",2)
                              AddXP2DA("ID1EX1A")
                              DisplayStringNoNameDlg(LastTalkedToBy,@18511)
                              EraseJournalEntry(@23781)
                              EraseJournalEntry(@32002)
