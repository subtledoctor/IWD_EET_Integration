...
IF ~~ THEN BEGIN 1
  ...
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @23279 DO ~AddXP2DA("ID1EX9H")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26704)~ GOTO 22
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @23279 DO ~AddXP2DA("ID1EX1H")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26704)~ GOTO 22
...
IF ~~ THEN BEGIN 16
  SAY @23328
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @23329 DO ~AddXP2DA("ID1EX9H")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26588)~ GOTO 17
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @23329 DO ~AddXP2DA("ID1EX1H")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26588)~ GOTO 17
  IF ~Alignment(LastTalkedToBy,MASK_EVIL)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @23330 DO ~AddXP2DA("ID1EX9H")
                                                                 DisplayStringNoNameDlg(LastTalkedToBy,@26699)~ GOTO 38
  IF ~Alignment(LastTalkedToBy,MASK_EVIL)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @23330 DO ~AddXP2DA("ID1EX1H")
                                                                 DisplayStringNoNameDlg(LastTalkedToBy,@26699)~ GOTO 38
END
...
IF ~~ THEN BEGIN 19
  ...
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @23343 DO ~SetGlobal("Know_Assassin","GLOBAL",2)
                              SetGlobal("Know_Plot","GLOBAL",1)
                              AddXP2DA("ID1EX9H")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26703)~ GOTO 40
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @23343 DO ~SetGlobal("Know_Assassin","GLOBAL",2)
                              SetGlobal("Know_Plot","GLOBAL",1)
                              AddXP2DA("ID1EX1H")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26703)~ GOTO 40
END
...
IF ~~ THEN BEGIN 59
  SAY @23465
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN DO ~SetGlobal("Seer_Ghost_State","GLOBAL",1)
  ...
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN DO ~SetGlobal("Seer_Ghost_State","GLOBAL",1)
                 SetGlobal("Wylf_Seer_Showdown","GLOBAL",1)
                 SetGlobal("Hjollder_Quest","GLOBAL",11)
                 AddXP2DA("ID1EX1H")
                 DisplayStringNoNameDlg(LastTalkedToBy,@18522)
...
IF ~~ THEN BEGIN 69
  SAY @23465
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN DO ~SetGlobal("Hjollder_Quest","GLOBAL",11)
                 AddXP2DA("ID1EX9H")
                 DisplayStringNoNameDlg(LastTalkedToBy,@18522)
                 AddJournalEntry(@23527,QUEST)~ GOTO 70
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN DO ~SetGlobal("Hjollder_Quest","GLOBAL",11)
                 AddXP2DA("ID1EX1H")
                 DisplayStringNoNameDlg(LastTalkedToBy,@18522)
                 AddJournalEntry(@23527,QUEST)~ GOTO 70
END
