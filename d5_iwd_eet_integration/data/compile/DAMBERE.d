...
IF ~~ THEN BEGIN 9
  ...
  IF ~CheckStatGT(LastTalkedToBy,12,CHR) 
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @21915 DO ~SetGlobal("Ambere_Family","GLOBAL",1)
                                                                AddXP2DA("ID1EX6E")
                                                                DisplayStringNoNameDlg(LastTalkedToBy,@18518)
                                                                AddJournalEntry(@23781,QUEST)~ GOTO 10
  IF ~CheckStatGT(LastTalkedToBy,12,CHR) 
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @21915 DO ~SetGlobal("Ambere_Family","GLOBAL",1)
                                                                AddXP2DA("ID1EX1E")
                                                                DisplayStringNoNameDlg(LastTalkedToBy,@18518)
                                                                AddJournalEntry(@23781,QUEST)~ GOTO 10
...
IF ~~ THEN BEGIN 13
  SAY @21926
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @21927 DO ~SetGlobal("Ambere_Family","GLOBAL",2)
                              AddXP2DA("ID1EX6E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@18523)
                              AddJournalEntry(@32002,QUEST)~ GOTO 14
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @21927 DO ~SetGlobal("Ambere_Family","GLOBAL",2)
                              AddXP2DA("ID1EX1E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@18523)
                              AddJournalEntry(@32002,QUEST)~ GOTO 14
END
