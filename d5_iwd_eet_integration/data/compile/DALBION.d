...
~NumTimesTalkedTo(0)~ THEN BEGIN 0
  ...
  IF ~OR(2)
        ...
        Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1211 DO ~SetGlobal("CDTalkedAlbion","GLOBAL",1)~ GOTO 2
  IF ~OR(2)
        !Class(LastTalkedToBy,PALADIN_ALL)
  ...
  IF ~OR(2)
        !Class(LastTalkedToBy,PALADIN_ALL)
        Kit(LastTalkedToBy,BLACKGUARD)
        Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1220 DO ~AddJournalEntry(@3354,QUEST)
...
IF ~~ THEN BEGIN 1
  ...
  IF ~Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1224 GOTO 6
  IF ~Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1225 GOTO 7
  IF ~~ THEN REPLY @1227 GOTO 5
END

IF ~~ THEN BEGIN 2
  SAY @1228
  IF ~Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1229 GOTO 7
...
IF ~~ THEN BEGIN 3
  ...
  IF ~Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1234 GOTO 7
END
...
IF ~~ THEN BEGIN 10
  ...
  IF ~Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1268 GOTO 7
END

IF ~~ THEN BEGIN 11
  SAY @1270
  IF ~Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1271 GOTO 7
  IF ~~ THEN REPLY @1273 GOTO 5
END

IF ~~ THEN BEGIN 12
  SAY @1274
  IF ~Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1275 GOTO 7
...
~NumTimesTalkedToGT(0)
 Global("Yuanti_Surprise","GLOBAL",0)~ THEN BEGIN 13
  ...
  IF ~OR(2)
        !Class(LastTalkedToBy,PALADIN_ALL)
        Kit(LastTalkedToBy,BLACKGUARD)
        Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1279 GOTO 14
  IF ~OR(2)
        !Class(LastTalkedToBy,PALADIN_ALL)
...
IF ~~ THEN BEGIN 15
  SAY @1287
  IF ~Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1288 GOTO 14
...
IF ~~ THEN BEGIN 23
  SAY @1318
  IF ~Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1319 DO ~AddXP2DA("ID1EX7A")
                             DisplayStringNoNameDlg(LastTalkedToBy,@6250)
                             SetGlobal("Yuanti_Inferno","GLOBAL",1)
                             Enemy()~ EXIT
  IF ~Global("D5_IWD_EET","GLOBAL",1)~ THEN REPLY @1319 DO ~AddXP2DA("ID1EX3A")
                             DisplayStringNoNameDlg(LastTalkedToBy,@6250)
                             SetGlobal("Yuanti_Inferno","GLOBAL",1)
                             Enemy()~ EXIT
  IF ~Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1320 DO ~AddXP2DA("ID1EX7A")
                             DisplayStringNoNameDlg(LastTalkedToBy,@6250)
                             SetGlobal("Yuanti_Inferno","GLOBAL",1)
                             Enemy()~ EXIT
  IF ~Global("D5_IWD_EET","GLOBAL",0)~ THEN REPLY @1321 DO ~AddXP2DA("ID1EX7A")
                             DisplayStringNoNameDlg(LastTalkedToBy,@6250)
                             SetGlobal("Yuanti_Inferno","GLOBAL",1)
                             Enemy()~ EXIT
  IF ~Global("D5_IWD_EET","GLOBAL",1)~ THEN REPLY @1321 DO ~AddXP2DA("ID1EX3A")
                             DisplayStringNoNameDlg(LastTalkedToBy,@6250)
                             SetGlobal("Yuanti_Inferno","GLOBAL",1)
                             Enemy()~ EXIT
END
