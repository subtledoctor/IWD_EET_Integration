...
IF ~~ THEN BEGIN 5
  ...
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22395 DO ~SetGlobal("Hailee_Joke","GLOBAL",4)
                              AddXP2DA("ID1EX6E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@18525)
                              AddJournalEntry(@34106,QUEST)~ GOTO 7
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22395 DO ~SetGlobal("Hailee_Joke","GLOBAL",4)
                              AddXP2DA("ID1EX1E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@18525)
                              AddJournalEntry(@34106,QUEST)~ GOTO 7
END
...
IF ~~ THEN BEGIN 6
  ...
  IF ~Alignment(LastTalkedToBy,MASK_EVIL)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22399 DO ~SetGlobal("Hailee_Joke","GLOBAL",4)
                                                                 AddXP2DA("ID1EX6E")
                                                                 DisplayStringNoNameDlg(LastTalkedToBy,@18525)
                                                                 AddJournalEntry(@34106,QUEST)~ GOTO 7
  IF ~Alignment(LastTalkedToBy,MASK_EVIL)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22399 DO ~SetGlobal("Hailee_Joke","GLOBAL",4)
                                                                 AddXP2DA("ID1EX1E")
                                                                 DisplayStringNoNameDlg(LastTalkedToBy,@18525)
                                                                 AddJournalEntry(@34106,QUEST)~ GOTO 7
  IF ~~ THEN REPLY @22391 GOTO 2
...
IF ~GlobalGT("Talk_Hailee","GLOBAL",0)
  ...
  IF ~Global("Hailee_Joke","GLOBAL",2)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22407 DO ~SetGlobal("Hailee_Joke","GLOBAL",4)
                                                              AddXP2DA("ID1EX6E")
                                                              DisplayStringNoNameDlg(LastTalkedToBy,@18519)
                                                              AddJournalEntry(@34105,QUEST)~ GOTO 9
  IF ~Global("Hailee_Joke","GLOBAL",2)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22407 DO ~SetGlobal("Hailee_Joke","GLOBAL",4)
                                                              AddXP2DA("ID1EX1E")
                                                              DisplayStringNoNameDlg(LastTalkedToBy,@18519)
                                                              AddJournalEntry(@34105,QUEST)~ GOTO 9
  IF ~Global("Hailee_Joke","GLOBAL",3)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22408 DO ~SetGlobal("Hailee_Joke","GLOBAL",4)
                                                              AddXP2DA("ID1EX6E")
                                                              DisplayStringNoNameDlg(LastTalkedToBy,@18519)
                                                              AddJournalEntry(@34105,QUEST)~ GOTO 9
  IF ~Global("Hailee_Joke","GLOBAL",3)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22408 DO ~SetGlobal("Hailee_Joke","GLOBAL",4)
                                                              AddXP2DA("ID1EX1E")
                                                              DisplayStringNoNameDlg(LastTalkedToBy,@18519)
                                                              AddJournalEntry(@34105,QUEST)~ GOTO 9
END
...
IF ~~ THEN BEGIN 19
  SAY @22443
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22444 DO ~SetGlobal("Know_Hailee_Secret","GLOBAL",2)
                              AddXP2DA("ID1EX6E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@18524)
                              AddJournalEntry(@34099,QUEST)~ GOTO 20
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22444 DO ~SetGlobal("Know_Hailee_Secret","GLOBAL",2)
                              AddXP2DA("ID1EX1E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@18524)
                              AddJournalEntry(@34099,QUEST)~ GOTO 20
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22445 DO ~SetGlobal("Know_Hailee_Secret","GLOBAL",2)
                              AddXP2DA("ID1EX6E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@18524)
                              AddJournalEntry(@34099,QUEST)~ GOTO 20
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22445 DO ~SetGlobal("Know_Hailee_Secret","GLOBAL",2)
                              AddXP2DA("ID1EX1E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@18524)
                              AddJournalEntry(@34099,QUEST)~ GOTO 20
END
...
IF ~~ THEN BEGIN 34
  ...
  IF ~Gender(LastTalkedToBy,MALE)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22487 DO ~AddXP2DA("ID1EX6E")
                                                         DisplayStringNoNameDlg(LastTalkedToBy,@18515)
                                                         AddJournalEntry(@34093,QUEST)~ GOTO 35
  IF ~Gender(LastTalkedToBy,MALE)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22487 DO ~AddXP2DA("ID1EX1E")
                                                         DisplayStringNoNameDlg(LastTalkedToBy,@18515)
                                                         AddJournalEntry(@34093,QUEST)~ GOTO 35
...
IF ~~ THEN BEGIN 47
  ...
  IF ~Global("Bear_Story","GLOBAL",1)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22549 DO ~SetGlobal("Hailee_Home","GLOBAL",1)
                                                             AddXP2DA("ID1EX6E")
  ...
  IF ~Global("Bear_Story","GLOBAL",1)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22549 DO ~SetGlobal("Hailee_Home","GLOBAL",1)
                                                             AddXP2DA("ID1EX1E")
                                                             DisplayStringNoNameDlg(LastTalkedToBy,@18516)
                                                             EraseJournalEntry(@34107)
                                                             EraseJournalEntry(@34106)
  ...
  IF ~Global("Fish_Story","GLOBAL",1)
      ...
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22552 DO ~SetGlobal("Hailee_Home","GLOBAL",2)
                                                                           AddXP2DA("ID1EX6E")
  ...
  IF ~Global("Fish_Story","GLOBAL",1)
      Global("SPRITE_IS_DEADTybaldDunn","GLOBAL",0)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22552 DO ~SetGlobal("Hailee_Home","GLOBAL",2)
                                                                           AddXP2DA("ID1EX1E")
                                                                           DisplayStringNoNameDlg(LastTalkedToBy,@18527)
                                                                           EraseJournalEntry(@34107)
                                                                           EraseJournalEntry(@34106)
  ...
  IF ~Global("Barbarian_Story","GLOBAL",1)
      Global("SPRITE_IS_DEADTybaldDunn","GLOBAL",0)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22555 DO ~SetGlobal("Hailee_Home","GLOBAL",3)
                                                                           AddXP2DA("ID1EX6E")
                                                                           DisplayStringNoNameDlg(LastTalkedToBy,@18527)
                                                                           EraseJournalEntry(@34107)
                                                                           EraseJournalEntry(@34106)
  ...
  IF ~Global("Barbarian_Story","GLOBAL",1)
      Global("SPRITE_IS_DEADTybaldDunn","GLOBAL",0)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22555 DO ~SetGlobal("Hailee_Home","GLOBAL",3)
                                                                           AddXP2DA("ID1EX1E")
                                                                           DisplayStringNoNameDlg(LastTalkedToBy,@18527)
                                                                           EraseJournalEntry(@34107)
                                                                           EraseJournalEntry(@34106)
  ...
  IF ~GlobalGT("Ambere_Family","GLOBAL",1)
      ...
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22556 DO ~SetGlobal("Hailee_Home","GLOBAL",4)
                                                                           AddXP2DA("ID1EX6E")
                                                                           DisplayStringNoNameDlg(LastTalkedToBy,@18527)
                                                                           EraseJournalEntry(@34107)
                                                                           EraseJournalEntry(@34106)
  ...
  IF ~GlobalGT("Ambere_Family","GLOBAL",1)
      Global("SPRITE_IS_DEADAmbereDunn","GLOBAL",0)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22556 DO ~SetGlobal("Hailee_Home","GLOBAL",4)
                                                                           AddXP2DA("ID1EX1E")
                                                                           DisplayStringNoNameDlg(LastTalkedToBy,@18527)
                                                                           EraseJournalEntry(@34107)
                                                                           EraseJournalEntry(@34106)
  ...
  IF ~GlobalGT("Know_Hailee_Secret","GLOBAL",1)
      ...
      OR(2)
        ...
        Kit(LastTalkedToBy,BLACKGUARD)~ THEN REPLY @22557 DO ~SetGlobal("Hailee_Home","GLOBAL",5)
                                                              ...
                                                              AddJournalEntry(@34089,QUEST_DONE)~ GOTO 49
  IF ~Alignment(LastTalkedToBy,MASK_EVIL)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22558 DO ~SetGlobal("Hailee_Home","GLOBAL",6)
                                                                 AddXP2DA("ID1EX6E")
                                                                 ...
                                                                 AddJournalEntry(@34089,QUEST_DONE)~ GOTO 49
  IF ~Alignment(LastTalkedToBy,MASK_EVIL)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22558 DO ~SetGlobal("Hailee_Home","GLOBAL",6)
                                                                 AddXP2DA("ID1EX1E")
                                                                 DisplayStringNoNameDlg(LastTalkedToBy,@18526)
                                                                 EraseJournalEntry(@34107)
                                                                 EraseJournalEntry(@34106)
