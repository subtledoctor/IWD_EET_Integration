...
IF ~~ THEN BEGIN 11
  ...
  IF ~GlobalGT("Know_Assassin","GLOBAL",1)
      ...
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @23767 DO ~SetGlobal("Angaar_2","GLOBAL",1)
                                                            AddXP2DA("ID1EX9E")
                                                            DisplayStringNoNameDlg(LastTalkedToBy,@26707)
                                                            AddJournalEntry(@23550,QUEST)~ GOTO 16
  IF ~GlobalGT("Know_Assassin","GLOBAL",1)
      !Global("Angaar_2","GLOBAL",1)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @23767 DO ~SetGlobal("Angaar_2","GLOBAL",1)
                                                            AddXP2DA("ID1EX1E")
                                                            DisplayStringNoNameDlg(LastTalkedToBy,@26707)
                                                            AddJournalEntry(@23550,QUEST)~ GOTO 16
  IF ~!Global("Angaar_3","GLOBAL",1)
  Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @23770 DO ~SetGlobal("Angaar_3","GLOBAL",1)
                                                            AddXP2DA("ID1EX9E")
                                                            DisplayStringNoNameDlg(LastTalkedToBy,@26708)
                                                            AddJournalEntry(@23549,QUEST)~ GOTO 19
  IF ~!Global("Angaar_3","GLOBAL",1)
  Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @23770 DO ~SetGlobal("Angaar_3","GLOBAL",1)
                                                            AddXP2DA("ID1EX1E")
                                                            DisplayStringNoNameDlg(LastTalkedToBy,@26708)
                                                            AddJournalEntry(@23549,QUEST)~ GOTO 19
...
IF ~~ THEN BEGIN 22
  SAY @24026
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @23766 DO ~AddXP2DA("ID1EX9E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26706)~ GOTO 13
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @23766 DO ~AddXP2DA("ID1EX1E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26706)~ GOTO 13
END
...
IF ~~ THEN BEGIN 25
  SAY @24041
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @24042 DO ~StartCutSceneMode()
                              AddXP2DA("ID1EX9E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@18521)
                              StartCutScene("bcPtyLve")~ EXIT
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @24042 DO ~StartCutSceneMode()
                              AddXP2DA("ID1EX1E")
                              DisplayStringNoNameDlg(LastTalkedToBy,@18521)
                              StartCutScene("bcPtyLve")~ EXIT
END
