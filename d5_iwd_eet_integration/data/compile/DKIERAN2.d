...
~Global("Kieran_Protected","GLOBAL",1)~ THEN BEGIN 22
  ...
  IF ~Global("Know_Mirror_Door","GLOBAL",2)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @26417 DO ~SetGlobal("Kieran_Protected","GLOBAL",2)
                                                                   AddXP2DA("ID1EX12V")
                                                                   DisplayStringNoNameDlg(LastTalkedToBy,@26585)
                                                                   StartStore("Kieran2",LastTalkedToBy)~ EXIT
  IF ~Global("Know_Mirror_Door","GLOBAL",2)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @26417 DO ~SetGlobal("Kieran_Protected","GLOBAL",2)
                                                                   AddXP2DA("ID1EX2V")
                                                                   DisplayStringNoNameDlg(LastTalkedToBy,@26585)
                                                                   StartStore("Kieran2",LastTalkedToBy)~ EXIT
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @26418 DO ~SetGlobal("Kieran_Protected","GLOBAL",2)
                              AddXP2DA("ID1EX12V")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26585)
                              StartStore("Kieran1",LastTalkedToBy)~ EXIT
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @26418 DO ~SetGlobal("Kieran_Protected","GLOBAL",2)
                              AddXP2DA("ID1EX2V")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26585)
                              StartStore("Kieran1",LastTalkedToBy)~ EXIT
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @26419 DO ~SetGlobal("Kieran_Protected","GLOBAL",2)
                              AddXP2DA("ID1EX12V")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26585)
                              StartStore("Kieran3",LastTalkedToBy)~ EXIT
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @26419 DO ~SetGlobal("Kieran_Protected","GLOBAL",2)
                              AddXP2DA("ID1EX2V")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26585)
                              StartStore("Kieran3",LastTalkedToBy)~ EXIT
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @26420 DO ~SetGlobal("Kieran_Protected","GLOBAL",2)
                              AddXP2DA("ID1EX12V")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26585)~ GOTO 1
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @26420 DO ~SetGlobal("Kieran_Protected","GLOBAL",2)
                              AddXP2DA("ID1EX2V")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26585)~ GOTO 1
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @26421 DO ~SetGlobal("Kieran_Protected","GLOBAL",2)
                              AddXP2DA("ID1EX12V")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26585)~ EXIT
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @26421 DO ~SetGlobal("Kieran_Protected","GLOBAL",2)
                              AddXP2DA("ID1EX2V")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26585)~ EXIT
END
