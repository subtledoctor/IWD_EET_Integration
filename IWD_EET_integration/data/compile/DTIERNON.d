...
IF ~~ THEN BEGIN 1
  ...
  IF ~Race(LastTalkedToBy,DWARF)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @24340 DO ~AddXP2DA("ID1EX8E")
                                                        DisplayStringNoNameDlg(LastTalkedToBy,@18517)
                                                        SetGlobal("Tiernon_Rep","GLOBAL",1)
                                                        AddJournalEntry(@23537,QUEST)~ GOTO 49
  IF ~Race(LastTalkedToBy,DWARF)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @24340 DO ~AddXP2DA("ID1EX1E")
                                                        DisplayStringNoNameDlg(LastTalkedToBy,@18517)
                                                        SetGlobal("Tiernon_Rep","GLOBAL",1)
                                                        AddJournalEntry(@23537,QUEST)~ GOTO 49
  IF ~Race(LastTalkedToBy,DWARF)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @24341 DO ~AddXP2DA("ID1EX8E")
                                                        DisplayStringNoNameDlg(LastTalkedToBy,@18517)
                                                        SetGlobal("Tiernon_Rep","GLOBAL",1)
                                                        AddJournalEntry(@23537,QUEST)~ GOTO 49
  IF ~Race(LastTalkedToBy,DWARF)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @24341 DO ~AddXP2DA("ID1EX1E")
                                                        DisplayStringNoNameDlg(LastTalkedToBy,@18517)
                                                        SetGlobal("Tiernon_Rep","GLOBAL",1)
                                                        AddJournalEntry(@23537,QUEST)~ GOTO 49
...
IF ~~ THEN BEGIN 48
  ...
  IF ~NumTimesTalkedTo(1)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @24548 DO ~AddXP2DA("ID1EX8E")
                                                 DisplayStringNoNameDlg(LastTalkedToBy,@18517)
                                                 AddJournalEntry(@23538,QUEST)~ GOTO 49
  IF ~NumTimesTalkedTo(1)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @24548 DO ~AddXP2DA("ID1EX1E")
                                                 DisplayStringNoNameDlg(LastTalkedToBy,@18517)
                                                 AddJournalEntry(@23538,QUEST)~ GOTO 49
...
IF ~~ THEN BEGIN 50
  SAY @24553
  IF ~Race(LastTalkedToBy,DWARF)
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @24554 DO ~AddXP2DA("ID1EX8E")
                                                        DisplayStringNoNameDlg(LastTalkedToBy,@18517)
                                                        AddJournalEntry(@23537,QUEST)~ GOTO 46
  IF ~Race(LastTalkedToBy,DWARF)
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @24554 DO ~AddXP2DA("ID1EX1E")
                                                        DisplayStringNoNameDlg(LastTalkedToBy,@18517)
                                                        AddJournalEntry(@23537,QUEST)~ GOTO 46
...
IF ~~ THEN BEGIN 67
  SAY @26684
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN DO ~SetGlobal("Made_Tiernon_Weapon","GLOBAL",1)
                 AddXP2DA("ID1EX10A")
                 DisplayStringNoNameDlg(LastTalkedToBy,@18520)
                 AddJournalEntry(@23543,QUEST)
                 StartCutSceneMode()
                 StartCutScene("gnFdeDlg")~ EXIT
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN DO ~SetGlobal("Made_Tiernon_Weapon","GLOBAL",1)
                 AddXP2DA("ID1EX2A")
                 DisplayStringNoNameDlg(LastTalkedToBy,@18520)
                 AddJournalEntry(@23543,QUEST)
                 StartCutSceneMode()
