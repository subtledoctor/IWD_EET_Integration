...
~Global("Hjollder_Quest","GLOBAL",4)~ THEN BEGIN 33
  SAY @22699
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22700 DO ~SetGlobal("Hjollder_Quest","GLOBAL",5)
                              SetGlobal("Body_Count","GLOBAL",2)
                              AddXP2DA("ID1EX12A")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26308)~ GOTO 34
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22700 DO ~SetGlobal("Hjollder_Quest","GLOBAL",5)
                              SetGlobal("Body_Count","GLOBAL",2)
                              AddXP2DA("ID1EX2A")
                              DisplayStringNoNameDlg(LastTalkedToBy,@26308)~ GOTO 34
  IF ~Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @6159 DO ~SetGlobal("Hjollder_Quest","GLOBAL",5)
                             SetGlobal("Body_Count","GLOBAL",2)
                             AddXP2DA("ID1EX12A")
                             DisplayStringNoNameDlg(LastTalkedToBy,@26308)~ EXIT
  IF ~Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @6159 DO ~SetGlobal("Hjollder_Quest","GLOBAL",5)
                             SetGlobal("Body_Count","GLOBAL",2)
                             AddXP2DA("ID1EX2A")
                             DisplayStringNoNameDlg(LastTalkedToBy,@26308)~ EXIT
END
...
IF ~~ THEN BEGIN 41
  ...
  IF ~PartyHasItem("wylfins")
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22753 DO ~TakePartyItem("wylfins")
                                                     DestroyItem("wylfins")
  ...
  IF ~PartyHasItem("wylfins")
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22753 DO ~TakePartyItem("wylfins")
                                                     DestroyItem("wylfins")
                                                     SetGlobal("Hjollder_Quest","GLOBAL",7)
                                                     AddXP2DA("ID1EX2H")
                                                     DisplayStringNoNameDlg(LastTalkedToBy,@26309)
...
~Global("Hjollder_Quest","GLOBAL",6)~ THEN BEGIN 47
  SAY @22795
  IF ~PartyHasItem("wylfins")
      Global("D5_IWD_REAL","GLOBAL",1)~ THEN REPLY @22796 DO ~TakePartyItem("wylfins")
                                                     DestroyItem("wylfins")
                                                     SetGlobal("Hjollder_Quest","GLOBAL",7)
                                                     AddXP2DA("ID1EX12H")
                                                     DisplayStringNoNameDlg(LastTalkedToBy,@26309)
                                                     AddJournalEntry(@26299,QUEST)~ GOTO 48
  IF ~PartyHasItem("wylfins")
      Global("D5_IWD_REAL","GLOBAL",0)~ THEN REPLY @22796 DO ~TakePartyItem("wylfins")
                                                     DestroyItem("wylfins")
                                                     SetGlobal("Hjollder_Quest","GLOBAL",7)
                                                     AddXP2DA("ID1EX2H")
                                                     DisplayStringNoNameDlg(LastTalkedToBy,@26309)
